...
function viewHome(){
  ...
  <div class="hero">
    ...
    <p>Ripassiamo l'italiano giocando: nomi, verbi, aggettivi e articoli in tante sfide diverse.</p>
  </div>
  <div class="menu-grid">
...
function viewModeSelect(){
  ...
  <div class="mode-list">
    ...
    <button class="mode-card" onclick="goOrtografiaChoose()"><span class="emoji">🔤</span><div class="txt"><strong>Ortografia</strong><span>Ce/cie, ge/gie, sce/sci, gli/li, cu/qu, doppie, la H...</span></div></button>
  </div>`;
}
