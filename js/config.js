...
/* Incolla qui l'URL del tuo progetto Supabase e la chiave "anon" (pubblica).
   Le trovi in: dashboard Supabase → il tuo progetto → Project Settings → API.
   La chiave "anon" è fatta apposta per stare nel codice del sito (è protetta
   dalle regole di sicurezza del database, non da una password).
